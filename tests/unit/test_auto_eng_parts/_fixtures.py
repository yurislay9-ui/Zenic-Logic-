"""Shared fixtures for automation engine tests — imported into test files."""
...
def engine(temp_db):
    ...
    with patch("src.core.automation_engine.AutomationEngine._init_db"), \
         patch("src.core.automation_engine.AutomationEngine._load_workflows"):
