#!/bin/bash
# ============================================================
#  TITAN OMNISCALE X v13 - Instalador para Termux + proot-distro
#
...
echo -e "${CYAN}"
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  TITAN OMNISCALE X v13 - Instalador Termux/proot-distro   ║"
...
#!/bin/bash
# TITAN OMNISCALE X v13 - Script de inicio
